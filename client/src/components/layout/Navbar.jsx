  ...
  return (
    <header className="sticky top-0 z-40 flex h-20 items-center justify-between border-b border-gray-200 bg-white/80 px-3 backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/80 sm:px-4 md:px-8">
      ...
      <div className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <div>
          <h2 className="truncate text-lg font-bold text-gray-800 sm:text-xl md:text-2xl dark:text-white">
            Dashboard
          </h2>
...
>
  <div
    className="flex h-11 w-11 items-center justify-center rounded-full bg-indigo-600 font-bold text-white shadow-md transition duration-300 hover:scale-110 sm:h-12 sm:w-12"
  >
    {user?.name
      ?.split(" ")
      .map((word) => word[0])
  ...
  {/* Hover Card */}
  <div className="pointer-events-none absolute right-0 top-14 z-50 hidden w-56 rounded-2xl border border-gray-200 bg-white p-4 shadow-2xl group-hover:hidden dark:border-slate-700 dark:bg-slate-900 md:group-hover:block">
